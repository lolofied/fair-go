...
export const styles = sortCx({
    common: {
        root: [
            "group relative inline-flex h-max cursor-pointer items-center justify-center whitespace-nowrap font-body outline-brand transition duration-100 ease-linear before:absolute focus-visible:outline-2 focus-visible:outline-offset-2",
    ...
    colors: {
        primary: {
            root: [
                "bg-neutral-950 text-white shadow-xs-skeuomorphic ring-1 ring-transparent ring-inset hover:bg-neutral-800 data-loading:bg-neutral-800",
        ...
        "link-color": {
            root: [
                "justify-normal rounded-lg text-brand-secondary hover:bg-secondary_hover hover:text-brand-secondary_hover",
                // Icon styles
        ...
        "link-gray": {
            root: [
                "justify-normal rounded-lg text-tertiary hover:bg-secondary_hover hover:text-tertiary_hover",
                // Icon styles
                "*:data-icon:text-fg-quaternary hover:*:data-icon:text-fg-quaternary_hover",
            ].join(" "),
        },
        ...
        "link-destructive": {
            root: [
                "justify-normal rounded-lg text-error-primary outline-error hover:bg-error-primary hover:text-error-primary_hover",
                // Icon styles
                "*:data-icon:text-fg-error-secondary hover:*:data-icon:text-fg-error-primary",
            ].join(" "),
        },
